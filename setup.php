...
<?php }//makes sure php is running
	...
	<body style="background-color:#EEEEFF">
		...
		<form action='stp/setupformaction.php' method='post'>
			<table style="background-color: #DDDDFF;">
				...
				<tr><td>Database Host:          </td><td><input type='text' value='localhost' name='dbhost'></td><td><pre>    Unless your database is on a different server you probably don't need to change this  </pre></td></tr>
				<tr><td>Database Root User:     </td><td><input type='text' value='root'      name='dbroot'></td><td><pre>    This is the master MySQL account that will let you edit databases                     </pre></td></tr>
				<tr><td>Database Root Password: </td><td><input type='text' value=''          name='dbrootpass'></td><td><pre>    The root user password (this is not stored, only used to install the database)        </pre></td></tr>
				<tr><td>uDuck DB user:          </td><td><input type='text' value='uduser'    name='dbuser'></td><td><pre>    This is the user account that the uDuck application uses to connect to the DB         </pre></td></tr>
				<tr><td>uDuck DB user Password: </td><td><input type='text' value='udpass'    name='dbpass'></td><td><pre>    This password for the uDuck application account. Might want to change for security    </pre></td></tr>
				<tr><td>Database Name:          </td><td><input type='text' value='ud_db'     name='dbname'></td><td><pre>    Change this if you want to install more than one instance of uDuck on the server      </pre></td></tr>
				<tr><td colspan="2"><h3>uDuck Administrator Account</h3></td></tr>
				<tr><td>Desired Username:</td><td><input type='text' value='admin'            name='user'></td><td><pre>    This will be the superuser account that has full privileges for everything in uDuck</pre></td></tr>
				<tr><td>Desired Password: </td><td><input type='password' value=''            name='pass'></td><td><pre>    I won't force a strong password on you but it is recommended</pre></td></tr>
				<tr><td>Verify Password:  </td><td><input type='password' value=''            name='passv'></td><td><pre>    I hope you didn't forget your password already</pre></td></tr>
				<tr><td>Email Address:        </td><td><input type='text' value=''            name='email'></td><td><pre>    If you do ever forget your password, a link will be sent to your email to replace it</pre></td></tr><!--TODO implement this-->
